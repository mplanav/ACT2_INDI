...
DISTDIR = /home/marc/UNI/Q4/ACT2_INDI/AC2/projecte/.tmp/Exercici-21.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = main.cpp \
		MyForm.cpp \
		MyGLWidget.cpp \
		Model/model.cpp qrc_shaders.cpp \
		moc_MyForm.cpp \
		moc_MyGLWidget.cpp
OBJECTS       = main.o \
		MyForm.o \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp MyForm.cpp MyGLWidget.cpp Model/model.cpp $(DISTDIR)/
